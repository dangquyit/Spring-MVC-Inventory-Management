...
<c:url value="/process-login" var="processLogin" />
<body class="login">
	<div>
		<div class="login_wrapper">
			<div class="animate form login_form">
				<section class="login_content">
					<form:form modelAttribute="loginForm" action="${processLogin }"
						method="POST">
						<h1>Login Form</h1>
						<div>
						...
						<div class="separator">
							...
							<div>
								...
								<p>©2016 Inventory Management System. Privacy and Terms</p>
							</div>
						</div>
					</form:form>
				</section>
